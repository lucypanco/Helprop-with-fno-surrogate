...
# NLOPT_CXX_LIBRARIES       Name to the NLOPT library.
#
...
find_library(NLOPT_CXX_LIBRARY
  NAMES "nlopt_cxx"
  PATHS ${NLOPT_PREFIX}
        ${NLOPT_ROOT}
        ${NLOPT_ROOT}
...
if(NLOPT_CXX_LIBRARY)
  set(CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES} ${NLOPT_CXX_LIBRARY})
endif(NLOPT_CXX_LIBRARY)
...
if(NLOPT_FOUND)
  ...
  set(NLOPT_CXX_LIBRARIES ${NLOPT_CXX_LIBRARY})
  # log result
